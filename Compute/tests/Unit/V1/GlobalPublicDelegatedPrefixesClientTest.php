...
class GlobalPublicDelegatedPrefixesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $response = $client->delete($project, $publicDelegatedPrefix);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.GlobalPublicDelegatedPrefixes/Delete', $actualFuncCall);
    ...
    public function deleteExceptionTest()
    {
        ...
        $publicDelegatedPrefix = 'publicDelegatedPrefix1814851176';
        try {
            $client->delete($project, $publicDelegatedPrefix);
    ...
    public function getTest()
    {
        ...
        $project = 'project-309310695';
        $publicDelegatedPrefix = 'publicDelegatedPrefix1814851176';
        $response = $client->get($project, $publicDelegatedPrefix);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function insertTest()
    {
        ...
        $response = $client->insert($project, $publicDelegatedPrefixResource);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.GlobalPublicDelegatedPrefixes/Insert', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function insertExceptionTest()
    {
        ...
        $publicDelegatedPrefixResource = new PublicDelegatedPrefix();
        try {
            $client->insert($project, $publicDelegatedPrefixResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function patchTest()
    {
        ...
        $publicDelegatedPrefix = 'publicDelegatedPrefix1814851176';
        $publicDelegatedPrefixResource = new PublicDelegatedPrefix();
        $response = $client->patch($project, $publicDelegatedPrefix, $publicDelegatedPrefixResource);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.GlobalPublicDelegatedPrefixes/Patch', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getPublicDelegatedPrefix();
        $this->assertProtobufEquals($publicDelegatedPrefix, $actualValue);
    ...
    public function patchExceptionTest()
    {
        ...
        $publicDelegatedPrefixResource = new PublicDelegatedPrefix();
        try {
            $client->patch($project, $publicDelegatedPrefix, $publicDelegatedPrefixResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
