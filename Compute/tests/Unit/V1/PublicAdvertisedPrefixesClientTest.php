...
class PublicAdvertisedPrefixesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.PublicAdvertisedPrefixes/Delete', $actualFuncCall);
    ...
    public function deleteExceptionTest()
    {
        ...
        $publicAdvertisedPrefix = 'publicAdvertisedPrefix-1508738146';
        try {
            $client->delete($project, $publicAdvertisedPrefix);
    ...
    public function insertTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.PublicAdvertisedPrefixes/Insert', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getPublicAdvertisedPrefixResource();
    ...
    public function insertExceptionTest()
    {
        ...
        $publicAdvertisedPrefixResource = new PublicAdvertisedPrefix();
        try {
            $client->insert($project, $publicAdvertisedPrefixResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function patchTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.PublicAdvertisedPrefixes/Patch', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getPublicAdvertisedPrefix();
        $this->assertProtobufEquals($publicAdvertisedPrefix, $actualValue);
    ...
    public function patchExceptionTest()
    {
        ...
        $publicAdvertisedPrefixResource = new PublicAdvertisedPrefix();
        try {
            $client->patch($project, $publicAdvertisedPrefix, $publicAdvertisedPrefixResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
