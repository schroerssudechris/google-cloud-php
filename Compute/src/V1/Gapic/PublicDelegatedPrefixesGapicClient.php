...
class PublicDelegatedPrefixesGapicClient
{
    ...
    public function delete($project, $publicDelegatedPrefix, $region, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $publicDelegatedPrefix;
        $requestParamHeaders['public_delegated_prefix'] = $region;
     ...
     *     $region = 'region';
     *     // Iterate over pages of elements
     *     $pagedResponse = $publicDelegatedPrefixesClient->list_($project, $region);
     *     foreach ($pagedResponse->iteratePages() as $page) {
